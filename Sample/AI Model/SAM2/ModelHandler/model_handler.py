...
class SAM2Handler:
    ...
    def _load_sam2_model(self):
        ...
        try:
            ...
            config_file = os.path.join("sam2.1_hiera_l.yaml")
    ...
    def segment_image(self, image: np.ndarray) -> dict:
        ...
        if self.mask_generator is None:
            ...
            return {
                'segmented_image': image.copy(),  # 원본 이미지 반환
...
class ModelHandler:
    ...
    def test(self):
        ...
        logger.info(f"테스트 완료 - 결과 이미지 크기: {result['segmented_image'].shape}")
...
if __name__ == "__main__":
    ...
    logger.info("결과 이미지가 저장되었습니다: original_image.jpg, segmented_image.jpg, colored_mask.jpg")
