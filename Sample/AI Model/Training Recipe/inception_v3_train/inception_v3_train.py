...
def RecipeRun(**kwargs):
    ...
    if operation_channel: 
        ...
        class_code_set_id = get_classification_gt_dataset(operation_channel, access_token, dataset['gt_dataset_id'])
    else: 
        classification_gts = dataset['gt_dataset_id']
        class_code_set_id = dataset['gt_dataset_id']
    label_info, class_code_info, num_classes = generate_label_data(class_code_set_id, operation_channel, access_token)
    ...
    try:
        ...
        for epoch in range(1, hyperparameter['epoch']+1):
            ...
            remaining_epochs = hyperparameter['epoch'] - epoch
