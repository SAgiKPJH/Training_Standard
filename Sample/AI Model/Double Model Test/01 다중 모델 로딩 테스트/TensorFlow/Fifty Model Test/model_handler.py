...
class ModelHandler:
    def __init__(self, data, context):
        ...
        # 50개의 모델을 모두 로드 (model0.h5 ~ model49.h5)
        self.models = {}
        base_path = os.path.dirname(os.path.abspath(__file__))
        
        print(f"[LOG] 50개 모델 로드 시작...")
    ...
    def get_current_model(self):
        """현재 시간의 소수점 이하 부분을 *100해서 %50으로 모델 선택 (0~49)"""
        ...
        print(f"[LOG] 소수점 이하: {decimal_part:.4f} -> {decimal_x100} % 50 = {selected_model_idx} -> model{selected_model_idx}.h5 사용")
