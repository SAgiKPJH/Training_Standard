...
def save_base_model(model_name='convnext_large_384_in22ft1k', num_classes=4, save_dir='base_models'):
    """base 모델을 저장하는 함수
    
    Args:
        model_name (str): timm 모델 이름
    ...
    try:
        ...
        logger.info(f"Base model saved to: {save_path}")
