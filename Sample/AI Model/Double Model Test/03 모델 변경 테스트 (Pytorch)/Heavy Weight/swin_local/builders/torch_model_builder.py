...
class TorchModelBuilder:
    ...
    def init_model(self):
        ...
        self.model = create_model(
            'swin_large_patch4_window7_224',  # Swin-Large 모델 사용
            pretrained=True,
        ...
        # 사전 학습된 가중치 로드 시도
        try:
            weights_path = 'base_models/swin_large_patch4_window7_224_10_base.model'
    ...
    def save_model(self, epoch):
        """모델 저장"""
        save_path = f'saved_models/swin_large_model_epoch_{epoch+1}.pth'
