...
class Local_MonitoringBuilder:
    """Local implementation for monitoring training progress."""
    ...
    def monitoring(self, total_epoch, epoch, train_loss, validation_loss, epoch_elapsed_time):
        ...
        Args:
            ...
            validation_loss: Validation loss for current epoch
            epoch_elapsed_time: Time elapsed for current epoch in seconds
        """
